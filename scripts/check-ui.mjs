...
try {
 ...
 await page.addInitScript(fixture=>{window.fixture=fixture;},{mode:'planning',workflow:'college-savings',inputs:{monthlyBudget:400,children:[{age:8,saved:1000}]},articles:[article]});
